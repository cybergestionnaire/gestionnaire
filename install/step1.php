 ...
 <form method="post" action="step1.php">
    <div class="register-box">
        ...
        <div class="register-box-body">   
            ...
            <p>Cette &eacute;tape vous permet de v&eacute;rifier que les droits sont correctement positionn&eacute;s sur les fichiers et les dossiers
        ...
        <div class="box-footer">
            <button type="submit" class="btn btn-flat pull-right" name="step2" value="Etape 2 ">Etape 2&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-circle-right "></i></button>
        </div>
    </div><!-- register-box -->
    </form>
 <!-- jQuery 2.1.3 -->
