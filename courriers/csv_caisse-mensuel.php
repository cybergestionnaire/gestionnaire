...
$separator = ";";
	...
	header("Content-disposition: attachment; filename=caissedumois-".$date.".csv");
	
// Ligne entête	
$csv_output = "Etat de caisse pour le mois de ".getMonth($date)." ".date('Y');
$csv_output .= "\n";
...
if($nbprint>0){
	...
	$csv_output="Pas de données pour le mois demandé";
}
