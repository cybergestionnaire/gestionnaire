            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <p><?php echo $row["date_inscription_user"] ; ?></p>
                    </div>
                    <div class="form-group">
...
?>
                    ...
                    <div class="form-group">
                        <label>Nom :</label>
                        <input type="text" name="nom" value="<?php echo $nom;?>" onChange="javascript:this.value=this.value.toUpperCase();" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Pr&eacute;nom :</label>
                        <input type="text" name="prenom" value="<?php echo $prenom;?>" onchange="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1).toLowerCase();" class="form-control">
                    </div>
...
?>
                        ...
                        <input type="text" name="annee" maxlength="4" value="<?php echo $annee;?>" style="width:50px;">
                    </div>

                    <div class="form-group">
                        <label>Adresse :</label>
                        <textarea name="adresse" class="form-control"><?php echo $adresse;?></textarea>
                    </div>
...
?>
         <div class="form-group">
            ...
            <div class="row">  
                <div class="col-xs-5">
                    <input type="text" placeholder="Code postal" style="width: 100px;" name="codepostal" value="<?php echo $codepostal;?>" class="form-control"/>
                </div>
                <div class="col-xs-6">
                    <input type="text" maxlength="50" placeholder="Autre Commune" style="width: 150px;" name="commune" value="<?php echo $commune;?>" onchange="this.value = this.value.charAt(0).toUpperCase() + this.value.substr(1).toLowerCase();" class="form-control"/>
                </div>
            </div>
        </div>
    
        <div class="form-group">
            <input type="text" maxlength="50" placeholder="Pays" style="width: 150px;" name="pays" class="form-control" value="<?php echo $pays;?>" onchange="this.value = this.value.toUpperCase();"/>
        </div>
...
?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="telport" value="<?php echo $telport;?>" class="form-control">
        </div>
        <div class="form-group">
            <label>E-Mail :</label>
...
<?php
    foreach ($forfaits AS $forfait) {
        if ($temps == $forfait->getId()) {
            echo "<option value=\"" . $forfait->getId() . "\" selected>" . $forfait->getNom() . "</option>";
                }
                else
                {
                    echo "<option value=\"" . $forfait->getId() . "\">" . $forfait->getNom() . "</option>";
                }
            }
        ?>
        </select>
