        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                    <dt>Date<?php if ($pluriel) { echo "s";} ?></dt><dd><?php echo $dateheure;?></dd>
            ...
            <div class="box-body">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="<?php if ($b == '' or $b == 2 or $b == 3) { echo "active";} ?>"><a href="#tab_3" data-toggle="tab">Les ateliers (<?php echo $nbAteliers;?>)</a></li>
                        <li class="<?php if ($b == 5  or $b == 6 or $b == 7) { echo "active";} ?>"><a href="#tab_4" data-toggle="tab">Les sessions (<?php echo $nbSessions; ?>)</a></li>
                    </ul>
                    <div class="tab-content">
                    
                        <div class="tab-pane <?php if ($b == '' or $b == 2 or $b == 3) { echo "active";} ?>" id="tab_3">
<?php 
        //if ($nba > 0) {
        if ($nbAteliers > 0 ) {
?>
...
?>
                        ...
                        <div class="tab-pane <?php if ($b == 5 or $b == 6 or $b == 7) { echo "active";} ?>" id="tab_4">
<?php
        if ($nbSessions > 0) {
?>
                            <table class="table table-condensed">
