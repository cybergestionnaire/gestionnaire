...
class Impression
{
    ...
    public function getUtilisateur() {
        return return Utilisateur::getUtilisateurById($this->_idUtilisateur);
    }    
    ...
    public function getIdCaissier() {
        return return Utilisateur::getUtilisateurById($this->_idCaissier);
    }
    ...
    public static function creerImpression($type, $idUtilisateur, $idTarif, $nombreForfait, $date, $statut) {
        $impression = null;
        if ( $type != ""
