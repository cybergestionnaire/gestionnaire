            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="input-group">
                        ...
                        <input name="telephone" type="text" class="form-control" value="<?php echo isset($espaceAModifier) ? htmlentities($espaceAModifier->getTelephone()) : '';
                            ;
                            ?>" data-inputmask='"mask": "0112345678"' data-mask/>
                    </div>
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-fax"></i></div>
                        <input name="fax" type="text" class="form-control" value="<?php echo isset($espaceAModifier) ? htmlentities($espaceAModifier->getFax()) : '';
                               ;
                            ?>" data-inputmask='"mask": "0112345678"' data-mask/>
                    </div>
                    <div class="input-group">
