...
<div class="box"><div class="box-header"><h3 class="box-title">Au programme cette semaine &agrave; l'EPN</h3></div>
		<div class="box-body">
			 <!-- The time line -->
...
<div class="box"><div class="box-header"><h3 class="box-title">Au programme cette semaine &agrave; l'EPN</h3></div>
		<div class="box-body">
			...
			if($nbe>0){	
				...
				?>
							<!-- timeline time label -->
				<ul class="timeline"><li class="time-label"><span class="bg-red"> <?php echo getDayFr($dateAS); ?> &agrave; <?php echo $heureAS; ?></span></li><!-- /.timeline-label -->
					<li><i class="fa fa-keyboard-o bg-green"></i>
						<div class="timeline-item"><h3 class="timeline-header"><?php echo $titre; ?></h3>
