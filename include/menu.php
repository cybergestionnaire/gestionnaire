    ...
    <?php if ($_SESSION['status'] == 3 or $_SESSION['status'] == 4) {
        ...
        <form  method="post" action="index.php?a=1" class="sidebar-form">
            <div class="input-group">
                <input type="text" name="term" value="Recherche Adh&eacute;rent" onfocus="if (!this._haschanged) {
                                this.value = ''
                            }
                            ;
                            this._haschanged = true;" class="form-control">
    ...
    if ($_SESSION['status'] == 1) {
        ...
        <ul class="sidebar-menu">
            ...
            if ($m == "2") {
                ...
                echo "treeview";
            } ?>"><a href="index.php?m=2"><i class="fa fa-edit" ></i><span>Mon compte</span></a></li>
        ...
        if ($m == "20") {
            ...
            echo "treeview";
        } ?>"><a href="index.php?m=20"><i class="fa fa-print" ></i><span>Mes impressions</span></a></li>
            <li class="<?php
            if ($m == "6") {
                echo "active";
            } else {
                echo "treeview";
            } ?>"><a href="index.php?m=6"><i class="fa fa-graduation-cap" ></i><span>Mes formations</span></a></li>
            <li class="<?php
        if ($m == "3") {
            echo "active";
        } else {
            echo "treeview";
        } ?>"><a href="index.php?m=3"><i class="fa fa-calendar"></i><span>Mes r&eacute;servations</span></a></li>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php
                if ($m == "3") {
                    ...
                    echo "treeview";
                } ?>"><a href="index.php?m=3&jour=<?php echo date('d'); ?>&mois=<?php echo date('n'); ?>&annee=<?php echo date('Y'); ?>"><i class="fa fa-calendar"></i><span>Réservations</span></a></li>
            <?php
            ...
            if ($config->hasActiverConsole()) {
                ...
                <li class="<?php
                            if ($a == 41) {
                                ...
                                echo "treeview";
                            } ?>"><a href="index.php?a=41"><i class="fa fa-gears"></i> <span>Configuration</span> </a></li>
                        <?php
            } ?>        
            <li class="<?php
                    if ($a == 1 or ($a == 5 and $b == 6) or $a == 24 or $a == 23) {
                        echo "active";
                    } else {
                        echo "treeview";
                    } ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?php
            if (($a == 1 && $b != 1) or ($a == 5 and $b == 6)) {
                echo "active";
            } ?>"><a href="index.php?a=1"><i class="fa fa-angle-double-right"></i>Liste des Adh&eacute;rents</a></li>
                    <li class="<?php
            if ($a == 1 && $b == 1) {
                echo "active";
            } ?>"><a href="index.php?a=1&b=1"><i class="fa fa-angle-double-right"></i>Cr&eacute;er Adh&eacute;rent</a></li>
                    <li class="<?php
                        if ($a == 24) {
                            echo "active";
                        } ?>"><a href="index.php?a=24"><i class="fa fa-angle-double-right"></i>Pr&eacute;inscriptions</a></li>
            <?php if ($_SESSION['status'] == 4) {
                            ?>
                        <li class="<?php
                if ($a == 23) {
                    echo "active";
                } ?>"><a href="index.php?a=23"><i class="fa fa-angle-double-right"></i>Gestion des Admin/Anim</a></li>
    <?php
                        } ?>        
                </ul>
            </li>
            ...
            <li class="<?php
                ...
                <ul class="treeview-menu">
                    <li class="<?php
                        if ($a == 21) {
                            echo "active";
                        } ?>"><a href="index.php?a=21"><i class="fa fa-angle-double-right"></i>Impressions</a></li>
                    <li class="<?php
                        if ($a == 8) {
                            echo "active";
                        } ?>"><a href="index.php?a=8"><i class="fa fa-angle-double-right"></i>Forfaits Ateliers</a></li>
                </ul>
            </li>

            <li class="<?php
                if ($a == 11 or $a == 12 or $a == 18 or $a == 7 or $a == 10 or $a == 15 or $a == 17) {
                    echo "active";
                } else {
                    echo "treeview";
                } ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?php
        if ($a == 7 or $a == 10 or $a == 15 or $a == 17) {
            echo "active";
        } else {
            echo "treeview";
        } ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($a == 7) {
                                echo "active";
                            } ?>"><a href="index.php?a=7"><i class="fa fa-angle-double-right"></i> Cat&eacute;gories / Niveaux</a></li>
                            <li class="<?php
                    if ($a == 17) {
                        echo "active";
                    } ?>"><a href="index.php?a=17"><i class="fa fa-angle-double-right"></i> Sujets</a></li>
                    ...
                    if ($a == 11) {
                        echo "active";
                    } ?>"><a href="index.php?a=11"><i class="fa fa-angle-double-right"></i>Programmation en cours</a></li>
                    <li class="<?php
            if ($a == 12) {
                echo "active";
            } ?>"><a href="index.php?a=12"><i class="fa fa-angle-double-right"></i>Planifier un atelier</a></li>
                    <li class="<?php
            if ($a == 18) {
                echo "active";
            } ?>"><a href="index.php?a=18"><i class="fa fa-angle-double-right"></i>Archives</a></li>
                    <!-- <li class="icn_mail"><a href="index.php?a=33"> Gestion des courriers</a></li>-->
                </ul>
            </li>

            <li class="<?php
                    if ($a == 31 or $a == 37 or $a == 29 or $a == 34 or $a == 36) {
                        echo "active";
                    } else {
                        echo "treeview";
                    } ?>">
        ...
        if ($a == 29 or $a == 34) {
            echo "active";
        } ?>"><a href="index.php?a=29"><i class="fa fa-angle-double-right"></i>sujets</a></li>
                        </ul>
                    </li>
                    <li class="<?php
        if ($a == 31) {
            echo "active";
        } ?>"><a href="index.php?a=31&m=1"><i class="fa fa-angle-double-right"></i>Planifier une session</a></li>
                    <li class="<?php
        if ($a == 37) {
            echo "active";
        } ?>"><a href="index.php?a=37"><i class="fa fa-angle-double-right"></i>Sessions en cours</a></li>
                    <li class="<?php
        if ($a == 36) {
            echo "active";
        } ?>"><a href="index.php?a=36"><i class="fa fa-angle-double-right"></i>Archives</a></li>
                </ul>
            </li>
        ...
        if ($a == 5 && $b == 1) {
            echo "active";
        } ?>"><a href="index.php?a=5&b=1"><i class="fa fa-angle-double-right"></i>Adh&eacute;rents</a></li>
                    <li class="<?php
        if ($a == 5 && $b == 2) {
            echo "active";
        } ?>"><a href="index.php?a=5&b=2"><i class="fa fa-angle-double-right"></i>R&eacute;servations</a></li>
                    <li class="<?php
        if ($a == 5 && $b == 3) {
            echo "active";
        } ?>"><a href="index.php?a=5&b=3"><i class="fa fa-angle-double-right"></i>Impressions</a></li>
                    <li class="<?php
        if ($a == 5 && $b == 5) {
            echo "active";
        } ?>"><a href="index.php?a=5&b=5"><i class="fa fa-angle-double-right"></i>Sessions</a></li>
                    <li class="<?php
        if ($a == 5 && $b == 4) {
            echo "active";
        } ?>"><a href="index.php?a=5&b=4"><i class="fa fa-angle-double-right"></i>Ateliers</a></li>
                </ul>
            </li>
