...
?>
        ...
        <li class="<?php if ($a == 5) { echo "active"; } else { echo "treeview" ;} ?>">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="index.php?a=5&b=2"><i class="fa fa-angle-double-right"></i>R&eacute;servations</a></li>
                <li><a href="index.php?a=5&b=3"><i class="fa fa-angle-double-right"></i>Impressions</a></li>
                <li><a href="index.php?a=5&b=5"><i class="fa fa-angle-double-right"></i>Sessions</a></li>
                <li><a href="index.php?a=5&b=4"><i class="fa fa-angle-double-right"></i>Ateliers</a></li>
            </ul>
        </li>
