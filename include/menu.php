...
<?php   } ?>        
        ...
        <li class="<?php if ($a == 31 OR $a == 37 OR $a == 29 or $a == 34 OR $a == 36) { echo "active"; } else { echo "treeview" ;} ?>">
            <a href="#"><i class="fa fa-ticket"></i> <span>Sessions</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
                <li class="<?php if ( $a == 29 OR $a == 34) { echo "active treeview"; } else { echo "treeview" ;} ?>">
                    <a href="#"><i class="fa fa-angle-double-right"></i>Param&egrave;tres <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li class="<?php if ( $a == 29 OR $a == 34) { echo "active"; } ?>"><a href="index.php?a=29"><i class="fa fa-angle-double-right"></i>sujets</a></li>
                    </ul>
                </li>
