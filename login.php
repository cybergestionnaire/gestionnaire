...
?>
                <div class="form-group has-feedback">
                    <input type="text" tabindex="1" placeholder="nom utilisateur" required  name="log" class="form-control">
                </div>
        
                <div class="form-group has-feedback">
                    <input type="password" tabindex="2"   name="pass" placeholder="Password" class="form-control"  required>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button type="submit"  class="btn btn-primary btn-block btn-flat" name="submit" value="Entrer">Entr&eacute;e</button>  
                    </div>
                </div>
<?php 
